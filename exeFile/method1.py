...
def method1(auction_list, date_start='2014-03-13', date_end='2014-10-12'):
    for auction_name in auction_list:
        for fraction in fractionlist:
            ...
            item_profit_weekly_mean = grouped_auction['Profit'].mean()      # get "mean of item weekly profit"
            ...
            item_corr_df.to_csv('../corr_0313_1012/pve_top5/'+auction_name, index=False)
        print 'finish',auction_name,'...'
